...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Space(10)]
        [Tooltip("Maximum jump apex height (m) from takeoff. Level design: keep vertical gaps between consecutive landings around this value or less; long gaps need sprint (~SprintSpeed) for horizontal reach.")]
